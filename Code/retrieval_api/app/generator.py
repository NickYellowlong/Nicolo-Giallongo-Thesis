...
class TextGenerator:
    def __init__(self):
        ...
        self.no_architecture_system_prompt = None
        self.no_architecture_preset = None
        self.no_architecture_temperature = 0.9
        self.no_architecture_top_p = 0.9
    ...
    def set_no_architecture_system_info(self, info):
        """Set the system prompt for the no-architecture generation model"""
        self.no_architecture_system_prompt = info.get("system_prompt")
        self.no_architecture_preset = info.get("preset")
        self.no_architecture_temperature = info.get("temperature")
        self.no_architecture_top_p = info.get("top-p")
    ...
    def generateNoArchitecture(self, query: str) -> Dict[str, str]:
        """Generate the response to the query"""
        logging.info("Starting generation with query: " + query)
        try:
            response = requests.post(
