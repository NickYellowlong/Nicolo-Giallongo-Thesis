...
@router.post("/no_architecture", response_model=GenerateResponse)
async def generate_no_architecture(query: GenerateQuery):
    """
    Generate text based on the query
    ...
    try:
        ...
        # Perform extraction
        generated_text = generator.generateNoArchitecture(query.query)
        print("Generated text:")
        print(generated_text)
        content_string = generated_text.get("content", "{}")
        print("Content string:")
