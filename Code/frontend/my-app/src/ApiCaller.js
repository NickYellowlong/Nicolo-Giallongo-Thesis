...
export const api_caller = {
  ...
  generate_narration_no_architecture: async (content, maxScenes, currentScene) => {
    console.log("Generating narration without architecture. Content: ", content, " Max Scenes: ", maxScenes, " Current Scene: ", currentScene);
    return await api.post('/narration_no_architecture', { content: content, maxScenes: maxScenes, currentScene: currentScene });
  },
