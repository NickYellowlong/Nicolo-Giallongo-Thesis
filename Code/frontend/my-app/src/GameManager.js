...
export const GameManager = {
    ...
    sendActionNoArchitecture: async (action, maxScenes, currentScene) => {
        console.log("Sending action without architecture: ", action);
        const narration_return = await api_caller.generate_narration_no_architecture(action, maxScenes, currentScene);
        return narration_return;
    },
